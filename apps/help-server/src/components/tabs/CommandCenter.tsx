    ...
    <div className="space-y-10">
      ...
      <section>
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div
            className={`flex w-full sm:w-80 shrink-0 items-center gap-2 rounded-md border bg-(--bg-2) px-3 py-1.5 transition-colors ${
              cmdFilter ? 'border-primary shadow-sm' : 'border-(--line)'
            }`}
          >
            <svg
              width="12"
