...
export default function Sidebar({ docs }: SidebarProps) {
  ...
  return (
    <>
      <aside
        ref={asideRef}
        className={`fixed left-0 top-0 z-50 flex h-full w-64 flex-col border-r border-(--line) bg-(--bg) pt-14 shadow-(--shadow-2) transition-transform duration-200 ease-in-out ${
