...
maestro-install.js   (scaffold-only, idempotent)
  ...
  2. runtime scripts             → .claude/scripts/{maestro-set-session-workflow.cjs, maestro-render-orchestrator.cjs, bash-validation.sh, lib/maestro-session.cjs, lib/maestro-skill-regions.cjs}  (always refreshed)
