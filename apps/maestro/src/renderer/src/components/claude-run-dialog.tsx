...
import { AlertTriangle, Check, Copy, Play, Square, Terminal } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <div className="text-[11px] font-semibold text-subtle uppercase tracking-wide">What it may write</div>
