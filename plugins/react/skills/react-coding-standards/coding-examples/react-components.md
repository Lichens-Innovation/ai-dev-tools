- [Project React coding standards](#project-react-coding-standards)
  - [*HIGH* Prefer Breaking Down `<GodComponents />` into Subcomponents](#high-prefer-breaking-down-godcomponents--into-subcomponents)
  ...
  - [*HIGH* Avoid `{renderXyz()}` rendering template anti-pattern](#high-avoid-renderxyz-rendering-template-anti-pattern)
  ...
  - [*HIGH* Avoid storing JSX in variables and injecting in the return](#high-avoid-storing-jsx-in-variables-and-injecting-in-the-return)
  ...
  - [*HIGH* Prefer External Utility Functions Over Complex Logic in the Rendering Template](#high-prefer-external-utility-functions-over-complex-logic-in-the-rendering-template)
  ...
  - [*HIGH* Prefer External Filters and Sorters Over Inline Logic in Rendering](#high-prefer-external-filters-and-sorters-over-inline-logic-in-rendering)
  ...
  - [*HIGH* Promote pure typescript functions](#high-promote-pure-typescript-functions)
  ...
  - [*HIGH* Prefer Using Hooks for Business Logic Over Returning React Components](#high-prefer-using-hooks-for-business-logic-over-returning-react-components)
  ...
  - [*HIGH* Avoid `useCallback` missusage](#high-avoid-usecallback-missusage)
  ...
  - [*HIGH* The `useMemo` overusage](#high-the-usememo-overusage)
  ...
  - [*HIGH* Prefer Using Early Returns for Simplified Rendering in React Components](#high-prefer-using-early-returns-for-simplified-rendering-in-react-components)
  ...
  - [*HIGH* Move data outside the component for cleaner code](#high-move-data-outside-the-component-for-cleaner-code)
  ...
  - [*HIGH* Prefer Functions Over Custom Hooks](#high-prefer-functions-over-custom-hooks)
  ...
  - [*MEDIUM* Set Default Values While Destructuring Props](#medium-set-default-values-while-destructuring-props)
  ...
  - [*LOW* Prefer Fragments Over DOM Nodes](#low-prefer-fragments-over-dom-nodes)
  ...
  - [*LOW* Use React Fragment Shorthand](#low-use-react-fragment-shorthand)
  ...
  - [*LOW* Drop String Props Curly Braces](#low-drop-string-props-curly-braces)
  ...
  - [*LOW* Avoid Numeric Index for the Key Value of a React Element](#low-avoid-numeric-index-for-the-key-value-of-a-react-element)
...
This section outlines the coding patterns recommended for the project, focusing on `React` practices.

## *HIGH* Prefer Breaking Down `<GodComponents />` into Subcomponents

Components with excessive responsibilities (anti-patten, often exceeding 150 lines) are hard to maintain.
...
- **Avoid God Components:**
  - **Readability:** Huge components (often exceeding 150 lines) are hard to read, understand, and navigate. They attempt to handle too many tasks, making it difficult to discern the component's primary purpose.
...
## *HIGH* Avoid `{renderXyz()}` rendering template anti-pattern
...
## *HIGH* Avoid storing JSX in variables and injecting in the return
...
## *HIGH* Prefer External Utility Functions Over Complex Logic in the Rendering Template
...
## *HIGH* Prefer External Filters and Sorters Over Inline Logic in Rendering
...
## *HIGH* Promote pure typescript functions
...
## *HIGH* Prefer Using Hooks for Business Logic Over Returning React Components
...
## *HIGH* Avoid `useCallback` missusage
...
## *HIGH* Prefer Using Early Returns for Simplified Rendering in React Components
...
## *HIGH* Move data outside the component for cleaner code
...
## *HIGH* Prefer Functions Over Custom Hooks
...
## *MEDIUM* Conditionally executable handlers — use a dedicated handler with early returns
...
## *MEDIUM* Avoid Misusing the `use` Prefix
...
## *MEDIUM* Store the Selected Item by ID
...
## *MEDIUM* Clarify the Distinction Between Initial State and Current State
...
## *MEDIUM* Prefer Props Destructuring Over Direct Props Access
...
## *MEDIUM* Set Default Values While Destructuring Props
...
## *MEDIUM* Always Clean Up in Your `useEffect` Hooks
...
## *MEDIUM* Avoid Simple Assignment in State Update Functions
...
## *MEDIUM* Specify Types Explicitly in useState, useRef, etc.
...
## *LOW* Prefer Using `gap`, `rowGap`, and `columnGap` Over `margin` or `padding` in React Native
...
## *LOW* Prefer react-native `Pressable` Over `TouchableOpacity`
...
## *LOW* Prefer Fragments Over DOM Nodes
...
## *LOW* Use React Fragment Shorthand
...
## *LOW* Drop String Props Curly Braces
...
## *LOW* Use `ReactNode` instead of `JSX.Element | null | undefined`
...
## *LOW* Simplify Typing of Components Expecting Children Props
...
## *LOW* Avoid Numeric Index for the Key Value of a React Element
