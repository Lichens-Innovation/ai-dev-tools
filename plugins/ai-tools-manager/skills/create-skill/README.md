...
2. On submit the route calls `scaffoldSkill` in `@repo/maestro-core`: the directory and the `SKILL.md` frontmatter are written **immediately**, with no model involved.
