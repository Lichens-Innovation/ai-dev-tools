...
3. **Hooks**
   If the skill needs a hook (e.g. to collect input before the skill runs), add it to the plugin instead of user settings so it's distributed automatically. See [Hooks and Relative Paths](docs/plugins.md#hooks-and-relative-paths).
