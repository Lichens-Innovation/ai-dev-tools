// GENERATED by packages/maestro-core/scripts/build-plugin-libs.mjs — DO NOT EDIT.
// Source: packages/maestro-core/src/plugin-entries/maestro-skill-regions.ts
...
// src/plugin-entries/maestro-skill-regions.ts
